...
class XTextTheme {
  ...
  static TextTheme mainTextTheme = TextTheme(
    ...
    headlineMedium: const TextStyle().copyWith(fontSize: 20, fontWeight: FontWeight.w400, color: Colors.black),
    ...
    bodyMedium: const TextStyle().copyWith(fontSize: 16, fontWeight: FontWeight.w400, color: XColors.primaryTextColor),
    bodySmall: const TextStyle().copyWith(fontSize: 14, fontWeight: FontWeight.normal, color: Colors.black.withOpacity(0.5)),
